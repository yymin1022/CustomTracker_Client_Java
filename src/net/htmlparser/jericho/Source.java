...
public final class Source extends Segment implements Iterable<Segment> {
	 ...
	 *
	 * @param pos  the position in the source document from which to start the search, may be out of bounds.
	 * @param startTagType  the <code>StartTagType</code> to search for, must not be <code>null</code>.
	 ...
	 *
	 * @param pos  the position in the source document from which to start the search, may be out of bounds.
	 * @param endTagType  the <code>EndTagType</code> to search for, must not be <code>null</code>.
	...
	public EndTag getPreviousEndTag(final int pos, final EndTagType endTagType) {
		if (endTagType==null) throw new IllegalArgumentException("endTagType argument must not be null");
	 ...
	 *
	 * @param pos  the position in the source document from which to start the search, may be out of bounds.
	 * @param name  the {@linkplain StartTag#getName() name} of the end tag to search for, may be <code>null</code>.
	 ...
	 */
	public EndTag getPreviousEndTag(final int pos, String name) {
		if (name!=null) name=name.toLowerCase();
	 ...
	 *
	 * @param pos  the position in the source document from which to start the search, may be out of bounds.
	 * @param name  the {@linkplain EndTag#getName() name} of the end tag to search for, may be <code>null</code>.
	 ...
	 */
	public EndTag getNextEndTag(final int pos, String name, final EndTagType endTagType) {
		if (name!=null) name=name.toLowerCase();
